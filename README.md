# Приложение AI Chat с уведомелениями в телеграм
__Форк включает в себя доработку функционала в виде добавления уведомлений в телеграм о низком балансе__
__Инструкция по установке обновлена с учётом доработки__
...
5. **Настройка переменных окружения**
   ...
   - Для бота укажите две переменные
      TELEGRAM_BOT_TOKEN=7649222674:AAEdp6w55Wh7hSsumSzFWjYzXwhg5qoHmq4
      TELEGRAM_CHAT_ID=<chatid>

6. **Настройка уведомлений бота**
   - По желанию в /utils/notifications.py можно изменить имя пользователя и сумму, при которой будет срабатывать уведомление
...
- **Уведомелния в телеграм (utils/notifications.py)**
  - При балансе нриже $10 отправляет уведомление в телеграм через бота @chat_bot_alert_bot
